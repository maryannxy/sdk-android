...
public abstract class XYDeviceActionGetAdvertisingConfig extends XYDeviceAction {
    private static final String TAG = XYDeviceActionGetAdvertisingConfig.class.getSimpleName();
