...
abstract class XYDeviceActionSetMinor(device: XYDevice, var value: Int) : XYDeviceAction(device) {

    override val serviceId: UUID
        get() = XYDeviceService.BasicConfig

    override val characteristicId: UUID
        get() = XYDeviceCharacteristic.BasicConfigMinor
    ...
    companion object {
        ...
        private val TAG = XYDeviceActionSetMinor::class.java.simpleName
    }
}