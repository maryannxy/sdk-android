...
open class XYDeviceActionSetSelfTest(device: XYDevice, var value: Int) : XYDeviceAction(device) {
    ...
    companion object {
        ...
        private val TAG = com.xyfindables.sdk.action.XYDeviceActionSetSelfTest::class.java.simpleName
    }
}