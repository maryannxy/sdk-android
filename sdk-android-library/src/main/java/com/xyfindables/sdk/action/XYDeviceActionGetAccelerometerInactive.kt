...
abstract class XYDeviceActionGetAccelerometerInactive(device: XYDevice) : XYDeviceAction(device) {
    ...
    override val characteristicId: UUID
        get() = XYDeviceCharacteristic.SensorInactive
    ...
    override fun statusChanged(status: Int, gatt: BluetoothGatt, characteristic: BluetoothGattCharacteristic, success: Boolean): Boolean {
        ...
        when (status) {
            XYDeviceAction.STATUS_CHARACTERISTIC_READ -> value = characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT8, 0)!!
