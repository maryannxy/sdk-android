...
abstract class XYDeviceActionGetRegistrationModern(device: XYDevice) : XYDeviceAction(device) {
    ...
    companion object {
        private val TAG = XYDeviceActionGetRegistrationModern::class.java.simpleName
    }
}
