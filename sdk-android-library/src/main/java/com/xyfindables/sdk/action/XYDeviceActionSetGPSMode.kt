...
abstract class XYDeviceActionSetGPSMode(device: XYDevice, var value: Int) : XYDeviceAction(device) {
    ...
    companion object {
        ...
        private val TAG = XYDeviceActionSetGPSMode::class.java.simpleName
    }
}