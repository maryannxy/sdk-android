...
public abstract class XYDeviceActionGetAccelerometerThreshold extends XYDeviceAction {

    private static final String TAG = XYDeviceActionGetAccelerometerTimeout.class.getSimpleName();

    public byte[] value;

    public XYDeviceActionGetAccelerometerThreshold(XYDevice device) {
        super(device);
        Log.v(TAG, TAG);
    }
    ...
    public UUID getCharacteristicId() {
        return XYDeviceCharacteristic.SensorThreshold;
    }
