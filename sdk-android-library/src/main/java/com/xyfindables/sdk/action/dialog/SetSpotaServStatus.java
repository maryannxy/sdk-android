...
public abstract class SetSpotaServStatus extends XYDeviceAction {
    private static final String TAG = SetSpotaServStatus.class.getSimpleName();

    public byte[] value;

    public SetSpotaServStatus(XYDevice device, byte[] value) {
        super(device);
        this.value = value;
        Log.v(TAG, TAG);
    }
