...
public abstract class SetSpotaMemInfo extends XYDeviceAction {
    private static final String TAG = SetSpotaMemInfo.class.getSimpleName();

    public byte[] value;

    public SetSpotaMemInfo(XYDevice device, byte[] value) {
        super(device);
        this.value = value;
        Log.v(TAG, TAG);
    }
